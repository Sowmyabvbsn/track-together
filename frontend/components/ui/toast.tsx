...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[50] flex max-h-screen w-full flex-col gap-2 p-4 outline-none xs:max-w-[356px] sm:max-w-[420px]",
      className,
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root 
      ...
      {...props}
      // Improved touch interaction - add reasonable swipe distance
      data-swipe-threshold={50}
      // Ensure consistent swipe direction regardless of device
